defmodule BlockScoutWeb.LayoutView do
  ...
  @issue_url "https://github.com/jmesworld/core.github.io/issues"
  ...
  def logo do
    Keyword.get(application_config(), :logo) || "/images/jmes.png"
  end
  ...
  def subnetwork_title do
    Keyword.get(application_config(), :subnetwork) || "JMES"
  end
